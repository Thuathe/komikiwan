const images = [
  ...
  { src: '/img/3.jpg', alt: 'Kenangan 3', width: '20%', height: '60%', opacity: 0, top: '0%', left: '40%' },
  ...
  { src: '/img/6.jpg', alt: 'Kenangan 6', width: '25%', height: '40%', opacity: 0, top: '60%', left: '0%' },
  ...
  { src: '/img/9.jpg', alt: 'Kenangan 9', width: '20%', height: '60%', opacity: 0, top: '40%', left: '60%' },
  { src: '/img/10.jpg', alt: 'Kenangan 10', width: '20%', height: '50%', opacity: 0, top: '50%', left: '80%' },
]

const MemoryFlashback = () => {
  return (
<div className="w-screen overflow-hidden border-y-4 border-black mb-[400px] bg-black">
